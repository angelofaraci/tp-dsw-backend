import { User, UserClass } from "./user.entity.js"
import jwt from 'jsonwebtoken';

export class UserRepository {
    
    public async add(item:UserClass):Promise<string | undefined>{
...
//Busca usuario por _id y devuelve sus datos
    public async recoverOne(id:string): Promise<UserClass | undefined>{
